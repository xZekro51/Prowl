...
/// method. Instead, the parent <see cref="Canvas"/> traverses the hierarchy and calls
/// <see cref="BuildUI"/> on each <see cref="UIBehaviour"/> in depth-first order.
/// </remarks>
public abstract class UIBehaviour : MonoBehaviour
{
    /// <summary>
    /// Called by the owning <see cref="Canvas"/> during UI construction.
    /// Subclasses should use <paramref name="paper"/> to emit Paper elements.
    /// </summary>
    /// <param name="paper">The Paper instance provided by the owning Canvas.</param>
    /// <param name="context">
    ...
    /// <summary>
    /// Finds the nearest <see cref="Canvas"/> in the parent hierarchy.
    /// </summary>
    public Canvas? GetCanvas()
    {
        return GetComponentInParent<Canvas>(includeSelf: true);
    }
}
